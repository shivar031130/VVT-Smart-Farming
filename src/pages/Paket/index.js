      ...
      <div className="py-16 parent ">
        ...
        >
          <div className="mb-6">
            ...
            Your one stop smart farming solution plans at affordable price!!!
            </h3>
            <h1 className="text-4xl font-semibold text-center">
              Smart Farming Solutions <span className="text-primary"style={{ color: "#31BF73" }}>Promo Plans</span>
            </h1>
            <BottomLine />
            <Countdown />
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center mt-6 mb-6">
            {activeBtn === "wedding" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                ...
                <span className="text-primary"style={{ color: "#31BF73" }}>Smart IoT</span>Devices Integration Packages 
              </h3>
            )}
            {activeBtn === "tokoonline" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                ...
                <span className="text-primary"style={{ color: "#31BF73" }}>Precision Farming</span> Management Packages 
              </h3>
            )}
            {activeBtn === "companyprofile" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
               ...
               <span className="text-primary"style={{ color: "#31BF73" }}>Smart Irrigation </span> Control Packages 
              </h3>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
            {items.map((item) => (
              ...
              >
                ...
                <span className="justify-center text-center paket-featured">Discount 34%</span>
                ...
                <span className="flex justify-center mb-5 ">
                  ...
                  >
                    <button className="flex items-center gap-3 text-black duration-500 bg-transparent border-2 btn border-primary hover:bg-primary hover:border-transparent hover:text-white">
                      ...
                      <span className="text-button-mobile"style={{ color: "#31BF73" }}>More Information</span>
                    </button>
                  </a>
                </span>
