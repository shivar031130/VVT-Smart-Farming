...
const Tim = () => {
  ...
  return (
    <div className="py-16 parent" style={{ backgroundColor: "#FFFFFF" }}>
      <motion.div
        className="mb-12"
        initial="hidden"
      ...
      >
        <h3 className="text-center text-accent">Meet</h3>
        <h1 className="text-4xl font-semibold text-center">
          Our <span className="text-primary" style={{ color: "#31BF73" }}>Team</span>
        </h1>
        <BottomLine />
      </motion.div>
