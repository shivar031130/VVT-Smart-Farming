  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex flex-wrap items-center justify-between mt-16 mb-4">
        <span>
          <strong className="text-primary">VVT SmartFarming</strong>
        </span>
        <span>
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
        ...
        <div className="px-4 py-6 rounded shadow-lg md:col-span-2 lg:col-span-1">
          <div className="">
            <h4 className="mb-3 text-lg font-medium">Others:</h4>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <EmailShareButton url={url} title="VVT PRODUCTION -">
              <EmailIcon size={32} round={true} />
            </EmailShareButton>
            <FacebookShareButton url={url} title="VVT PRODUCTION -">
              <FacebookIcon size={32} round={true} />
            </FacebookShareButton>
            <TwitterShareButton url={url} title="VVT PRODUCTION -">
              <TwitterIcon size={32} round={true} />
            </TwitterShareButton>
            <LinkedinShareButton url={url} title="VVT PRODUCTION -">
              <LinkedinIcon size={32} round={true} />
            </LinkedinShareButton>
            <WhatsappShareButton url={url} title="VVT PRODUCTION -">
